...
export default function UI() {
    ...
    return (
        <div className="absolute top-0 left-0 w-full h-full">
            ...
            {uiState && (
                <>
                    <div className="bg-[url(/speedometer.svg)] w-40 h-40 bg-contain flex justify-center items-center">
                        <div className="w-0.5 h-20" style={
                            { transform: `rotate(${uiState.velocity.magnitude() / 300000000 * 320 + 200}deg)` }
                        }>
